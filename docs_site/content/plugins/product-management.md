...
| 항목 | 내용 |
|------|------|
| Skills | 3개 (user-interview, experiment-design, assumption-testing) |
...
> [상세 페이지 보기 →](/plugins/cc-pm-discovery/)
...
| 항목 | 내용 |
|------|------|
| Skills | 3개 (product-vision, business-model, competitive-analysis) |
...
> [상세 페이지 보기 →](/plugins/cc-pm-strategy/)
...
| 항목 | 내용 |
|------|------|
| Skills | 3개 (sql-analysis, cohort-analysis, ab-testing) |
...
> [상세 페이지 보기 →](/plugins/cc-pm-analytics/)
...
| 항목 | 내용 |
|------|------|
| Skills | 3개 (icp-definition, messaging-framework, gtm-motion) |
