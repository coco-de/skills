...
| 페르소나 | 페이즈 | 역할 |
|---------|--------|------|
| Analyst | Analysis | 요구사항 분석, **BDD Gherkin AC 작성** |
...
```
Phase 1: Analysis     → 요구사항 분석, BDD Gherkin AC 작성 ⭐
...
║  │   ├── BDD Gherkin AC 작성 ⭐                                 ║
║  │   └── 타당성 검토                                           ║
║  └── Gate: 요구사항 명확성, 스코프 적절성, AC Gherkin 형식     ║
║                                                                ║
║  Phase 2: PLANNING                                             ║
║  ├── 📝 PM 검토                                                ║
║  │   ├── Epic/Story 구조화                                     ║
...
| 게이트 | 필수 검증 항목 |
|--------|---------------|
| Analysis | 요구사항 명확성, 스코프 적절성, **AC BDD Gherkin 형식**, AC 완성도(happy-path + error-handling) |
