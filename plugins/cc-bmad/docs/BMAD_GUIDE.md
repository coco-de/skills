...
│  • Acceptance Criteria 정의   │    │  • SP 산정   │    │  • UX 검토   │    │  • 테스트    │
│  • 타당성    │    │  • 라벨링    │    │              │    │  • PR/머지   │
└──────────────┘    └──────────────┘    └──────────────┘    └──────────────┘
       │                  │                   │                   │
       ▼                  ▼                   ▼                   ▼
...
|--------|--------------|-----------------|
| **Analysis** | Analyst | 요구사항 명확성, 스코프 적절성, **Acceptance Criteria BDD Gherkin 형식** ⭐ |
...
| 페르소나 | 역할 | 담당 페이즈 |
|---------|------|-----------|
| **Analyst** | 요구사항 분석, **BDD Gherkin Acceptance Criteria 작성** ⭐, 타당성 검토 | Analysis |
